...
const questions: Question[] = [
  {
    id: 1,
    question: "What type of diagram shows the arrangement of electrons in energy levels around the nucleus?",
    options: ["Lewis dot diagram", "Bohr model", "Electron configuration", "All of the above"],
    correctAnswer: 1,
    explanation: "The Bohr model shows electrons arranged in specific energy levels (shells) around the nucleus."
  },
  {
    id: 2,
    question: "In a Lewis dot diagram, dots represent:",
    options: ["Protons", "Neutrons", "Valence electrons", "All electrons"],
    correctAnswer: 2,
    explanation: "Lewis dot diagrams show only the valence electrons (outermost electrons) as dots around the element symbol."
  },
  {
    id: 3,
    ...
    options: ["2", "4", "6", "8"],
    correctAnswer: 1,
    explanation: "Carbon has 4 valence electrons, which is why it can form 4 bonds with other atoms."
  },
  {
    id: 4,
    question: "What does the atomic number tell us about an element?",
    options: ["Number of neutrons", "Number of protons", "Mass number", "Number of electrons"],
    correctAnswer: 1,
    explanation: "The atomic number equals the number of protons in the nucleus, which determines the element's identity."
  },
  {
    id: 5,
    question: "In an electron configuration, what does the 's' orbital represent?",
    options: ["Spherical shape", "Sharp lines", "Small size", "Single electron"],
    correctAnswer: 0,
    explanation: "The 's' orbital has a spherical shape and can hold a maximum of 2 electrons."
  },
  {
    id: 6,
    ...
    options: ["2", "4", "6", "8"],
    correctAnswer: 3,
    explanation: "The second energy level can hold a maximum of 8 electrons (2 in the s orbital and 6 in the p orbital)."
  },
  {
    id: 7,
    question: "What is the electron configuration for helium?",
    options: ["1s¹", "1s²", "2s¹", "2s²"],
    correctAnswer: 1,
    explanation: "Helium has 2 electrons, both in the 1s orbital, giving it the electron configuration 1s²."
  },
  {
    id: 8,
    question: "Which diagram best shows the three-dimensional arrangement of atoms in a molecule?",
    options: ["Lewis dot diagram", "Bohr model", "Space-filling model", "Electron configuration"],
    correctAnswer: 2,
    explanation: "Space-filling models show the three-dimensional arrangement of atoms and their relative sizes in a molecule."
  }
];

export default function DiagramsQuiz() {
    ...
    return (
      <div className="space-y-8">
        <div className="text-center space-y-4">
          ...
          <p className="text-xl text-gray-600">Diagrams Quiz</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 text-center">
          ...
          {score.percentage >= 80 ? (
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
              <p className="text-green-800 font-semibold">🎉 Excellent! You have a strong understanding of chemical diagrams!</p>
            </div>
          ) : score.percentage >= 60 ? (
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
              <p className="text-red-800 font-semibold">📚 Keep studying! Review the diagram concepts and try again.</p>
            </div>
          )}
    ...
    <div className="space-y-8">
      ...
      <div className="text-center space-y-4">
        <div className="flex items-center justify-center space-x-4">
          <h1 className="text-4xl font-bold text-gray-800">📊 Diagrams Quiz</h1>
          <div className="flex items-center space-x-2 bg-yellow-100 px-4 py-2 rounded-full">
            <span className="text-2xl">💎</span>
            <span className="font-bold text-yellow-800">{gems}</span>
          </div>
        </div>
        <p className="text-xl text-gray-600">Test your knowledge of chemical diagrams</p>
      </div>
      ...
      <div className={`bg-white rounded-xl shadow-lg p-8 transition-all duration-300 ${
        ...
        {showExplanation && (
          <div className="mt-6 p-4 bg-purple-50 border border-purple-200 rounded-lg">
            <p className="text-purple-800 font-semibold mb-2">Explanation:</p>
            <p className="text-purple-700">{currentQ.explanation}</p>
          </div>
        )}
