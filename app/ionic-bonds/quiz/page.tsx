...
const questions: Question[] = [
  {
    ...
    correctAnswer: 1,
    explanation: "Ionic bonds form between metals and nonmetals when electrons are transferred from the metal to the nonmetal."
  },
  {
    id: 2,
    question: "What happens to atoms when they form an ionic bond?",
    options: ["They share electrons", "They transfer electrons", "They lose all electrons", "They gain protons"],
    correctAnswer: 1,
    explanation: "In ionic bonding, one atom transfers electrons to another atom, creating oppositely charged ions."
  },
  {
    id: 3,
    question: "What is the charge on a sodium ion (Na⁺)?",
    options: ["+1", "+2", "-1", "0"],
    correctAnswer: 0,
    explanation: "Sodium loses one electron to form Na⁺, giving it a +1 charge."
  },
  {
    id: 4,
    ...
    options: ["+1", "+2", "-1", "0"],
    correctAnswer: 2,
    explanation: "Chlorine gains one electron to form Cl⁻, giving it a -1 charge."
  },
  {
    id: 5,
    question: "What is the formula for table salt (sodium chloride)?",
    options: ["NaCl", "Na₂Cl", "NaCl₂", "Na₂Cl₂"],
    correctAnswer: 0,
    explanation: "Sodium chloride has the formula NaCl, with one sodium ion (Na⁺) and one chloride ion (Cl⁻)."
  },
  {
    id: 6,
    ...
    correctAnswer: 2,
    explanation: "NaCl (sodium chloride) is an ionic compound formed between the metal sodium and the nonmetal chlorine."
  },
  {
    id: 7,
    question: "What type of force holds ionic compounds together?",
    options: ["Covalent bonds", "Electrostatic attraction", "Hydrogen bonds", "Van der Waals forces"],
    correctAnswer: 1,
    explanation: "Ionic compounds are held together by electrostatic attraction between oppositely charged ions."
  },
  {
    id: 8,
    question: "Why do ionic compounds have high melting points?",
    options: ["They are gases at room temperature", "Strong electrostatic forces between ions", "They contain metals", "They are covalent compounds"],
    correctAnswer: 1,
    explanation: "Ionic compounds have high melting points because of the strong electrostatic forces between oppositely charged ions."
  }
];

export default function IonicBondsQuiz() {
    ...
    return (
      <div className="space-y-8">
        <div className="text-center space-y-4">
          ...
          <p className="text-xl text-gray-600">Ionic Bonds Quiz</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 text-center">
          ...
          {score.percentage >= 80 ? (
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
              <p className="text-green-800 font-semibold">🎉 Excellent! You have a strong understanding of ionic bonds!</p>
            </div>
          ) : score.percentage >= 60 ? (
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
              <p className="text-red-800 font-semibold">📚 Keep studying! Review the ionic bonds concepts and try again.</p>
            </div>
          )}
    ...
    <div className="space-y-8">
      ...
      <div className="text-center space-y-4">
        <div className="flex items-center justify-center space-x-4">
          <h1 className="text-4xl font-bold text-gray-800">⚡ Ionic Bonds Quiz</h1>
          <div className="flex items-center space-x-2 bg-yellow-100 px-4 py-2 rounded-full">
            <span className="text-2xl">💎</span>
            <span className="font-bold text-yellow-800">{gems}</span>
          </div>
        </div>
        <p className="text-xl text-gray-600">Test your knowledge of ionic bonding</p>
      </div>
